...
#os.makedirs('../data/girijaYe2019d')
runID = 'DMBC50RAP400EI150'
...
np.savetxt('../data/girijaYe2019d/'+runID+'vinf_kms_array.txt',vinf_kms_array)				
np.savetxt('../data/girijaYe2019d/'+runID+'v0_kms_array.txt',v0_kms_array)		
np.savetxt('../data/girijaYe2019d/'+runID+'betaRatio_array.txt',betaRatio_array)		
np.savetxt('../data/girijaYe2019d/'+runID+'overShootLimit_array.txt',overShootLimit_array)
np.savetxt('../data/girijaYe2019d/'+runID+'exitflag_os_array.txt',exitflag_os_array)
np.savetxt('../data/girijaYe2019d/'+runID+'underShootLimit_array.txt',underShootLimit_array)
np.savetxt('../data/girijaYe2019d/'+runID+'exitflag_us_array.txt',exitflag_us_array)
np.savetxt('../data/girijaYe2019d/'+runID+'TCW_array.txt',TCW_array)
...
np.savetxt('../data/girijaYe2019d/'+runID+'acc_net_g_max_array.txt',acc_net_g_max_array)	
np.savetxt('../data/girijaYe2019d/'+runID+'stag_pres_atm_max_array.txt',stag_pres_atm_max_array)	
np.savetxt('../data/girijaYe2019d/'+runID+'q_stag_total_max_array.txt',q_stag_total_max_array)	
np.savetxt('../data/girijaYe2019d/'+runID+'heatload_max_array.txt',heatload_max_array)
"""
x = np.loadtxt('../data/girijaYe2019d/'+runID+'vinf_kms_array.txt')
y = np.loadtxt('../data/girijaYe2019d/'+runID+'betaRatio_array.txt')

Z1 = np.loadtxt('../data/girijaYe2019d/'+runID+'TCW_array.txt')
G1 = np.loadtxt('../data/girijaYe2019d/'+runID+'acc_net_g_max_array.txt')
Q1 = np.loadtxt('../data/girijaYe2019d/'+runID+'q_stag_total_max_array.txt')
H1 = np.loadtxt('../data/girijaYe2019d/'+runID+'heatload_max_array.txt')
S1 = np.loadtxt('../data/girijaYe2019d/'+runID+'stag_pres_atm_max_array.txt')
...
plt.savefig('../plots/girijaYe2019d-fig17.png',bbox_inches='tight')
plt.savefig('../plots/girijaYe2019d-fig17.pdf', dpi=300,bbox_inches='tight')
plt.savefig('../plots/girijaYe2019d-fig17.eps', dpi=300,bbox_inches='tight')
