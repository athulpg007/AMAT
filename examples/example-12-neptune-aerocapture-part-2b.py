...
plt.hist(peri_dv_new, bins=15, color='xkcd:periwinkle')
...
plt.savefig('../plots/girijaSaikia2020b-prm-histogram-N100.png',bbox_inches='tight')
plt.savefig('../plots/girijaSaikia2020b-prm-histogram-N100.pdf', dpi=300,bbox_inches='tight')
plt.savefig('../plots/girijaSaikia2020b-prm-histogram-N100.eps', dpi=300,bbox_inches='tight')
