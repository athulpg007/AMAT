...
#LD_array       = np.linspace( 0.0,    0.4 , 2)

#os.makedirs('../data/girijaYe2019b')
runID = 'BC500RAP400EI150-'
...
for i in range(0,len(v0_kms_array)):
	for j in range(0,len(LD_array)):
		vehicle=Vehicle('Apollo', 1000.0, 500.0, LD_array[j], 3.1416, 0.0, 1.00, planet)
...
np.savetxt('../data/girijaYe2019b/'+runID+'vinf_kms_array.txt',vinf_kms_array)				
np.savetxt('../data/girijaYe2019b/'+runID+'v0_kms_array.txt',v0_kms_array)		
np.savetxt('../data/girijaYe2019b/'+runID+'LD_array.txt',LD_array)		
np.savetxt('../data/girijaYe2019b/'+runID+'overShootLimit_array.txt',overShootLimit_array)
np.savetxt('../data/girijaYe2019b/'+runID+'exitflag_os_array.txt',exitflag_os_array)
np.savetxt('../data/girijaYe2019b/'+runID+'undershootLimit_array.txt',underShootLimit_array)
np.savetxt('../data/girijaYe2019b/'+runID+'exitflag_us_array.txt',exitflag_us_array)
np.savetxt('../data/girijaYe2019b/'+runID+'TCW_array.txt',TCW_array)
...
np.savetxt('../data/girijaYe2019b/'+runID+'acc_net_g_max_array.txt',acc_net_g_max_array)	
np.savetxt('../data/girijaYe2019b/'+runID+'stag_pres_atm_max_array.txt',stag_pres_atm_max_array)	
np.savetxt('../data/girijaYe2019b/'+runID+'q_stag_total_max_array.txt',q_stag_total_max_array)	
np.savetxt('../data/girijaYe2019b/'+runID+'heatload_max_array.txt',heatload_max_array)


x = np.loadtxt('../data/girijaYe2019b/'+runID+'vinf_kms_array.txt')
y = np.loadtxt('../data/girijaYe2019b/'+runID+'LD_array.txt')

Z1 = np.loadtxt('../data/girijaYe2019b/'+runID+'TCW_array.txt')
G1 = np.loadtxt('../data/girijaYe2019b/'+runID+'acc_net_g_max_array.txt')
Q1 = np.loadtxt('../data/girijaYe2019b/'+runID+'q_stag_total_max_array.txt')
H1 = np.loadtxt('../data/girijaYe2019b/'+runID+'heatload_max_array.txt')
S1 = np.loadtxt('../data/girijaYe2019b/'+runID+'stag_pres_atm_max_array.txt')
...
plt.savefig('../plots/girijaYe2019b-fig13.png',bbox_inches='tight')
plt.savefig('../plots/girijaYe2019b-fig13.pdf', dpi=300,bbox_inches='tight')
plt.savefig('../plots/girijaYe2019b-fig13.eps', dpi=300,bbox_inches='tight')
