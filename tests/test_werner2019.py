...
class WernerBraun2019(unittest.TestCase):
	...
	def test_aerocapture_vehicle(self):
		...
		underShootLimit, exitflag_us = vehicle.findUnderShootLimitD(2400.0, 1.0, -20.0, -2.0, 1E-2, 1760.0)
		overShootLimit , exitflag_os =  vehicle.findOverShootLimitD(2400.0, 1.0, -20.0, -2.0, 1E-2, 1760.0)
		...
		self.assertAlmostEqual(overShootLimit,  -4.6496, places=2)
		self.assertAlmostEqual(underShootLimit, -5.1410, places=2)
